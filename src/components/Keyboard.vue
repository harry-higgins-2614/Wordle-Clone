<template>
<div class="mx-auto md:w-1/3 md:relative sticky md:bottom-[unset] bottom-0 left-auto right-auto w-screen md:bg-white bg-gray-100 pt-1 pb-1 md:border-t-0 md:border-b-0 border-b-2 border-t-2 border-gray-500">
